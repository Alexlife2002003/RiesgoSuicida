        ...
        child: Center(
          child: SingleChildScrollView(
            child: Column(
              ...
              Sections("2", "“Quien lo dice no lo hace y quien lo hace no lo dice”",
              ...
              Sections("4", "“Quien se suicida tiene una enfermedad mental”", "Tener trastornos mentales suponen un factor de riesgo para desarrollar conductas suicidas, pero no es un requisito necesario. La mayoría de las personas que se suicidan no tienen ninguna enfermedad mental."),
              Sections("5", "“La persona con conducta suicida está decidida a morir”", "Las personas que manifiestan conductas suicidas no quieren morir, solo quieren terminar con el dolor que sienten. En ese momento no ven otra alternativa a su sufrimiento."),
              Sections("6", "“El suicidio no se puede prevenir”", "Las conductas suicidas se pueden y se deben prevenir. El conocimiento sobre el tema, la prevención de factores de riesgo y la promoción de factores protectores son esenciales contra el suicidio. El suicidio es difícil de predecir, pero se puede prevenir."),
              Sections("7", "“El que se suicida es un cobarde/valiente”", "El suicidio no tiene nada que ver con la cobardía o la valentía sino con el sufrimiento y la desesperanza. Este mito puede fomentar actitudes de admiración o desprecio inadecuadas."),
              Sections("8", "“Si se reta a una persona en posible riesgo de suicidio, no lo intenta. ”", "La persona que está pensando en el suicidio está sufriendo intensamente y no encuentra como hacer frente a esa situación. Retarle es un acto irresponsable con el que la persona se siente todavía más sola e incomprendida.")
            ]),
          ),
        ),
      ),
