...
void _showPrivacyPolicy() {
  showDialog(
    ...
    builder: (context) {
      return AlertDialog(
        backgroundColor: Colors.grey.withOpacity(0.9), // Grey and transparent background
        title: const Text('Políticas de privacidad', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black)), // Title text
        ...
        actions: [
          TextButton(
            ...
            child: const Text('Close', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.black)), // Close button text
          ),
        ],
      );
    },
